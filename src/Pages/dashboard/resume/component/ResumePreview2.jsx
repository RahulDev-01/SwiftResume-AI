...
function ResumePreview2({ resumeInfo }) {
    return (
        <div className='shadow-lg p-10 border-t-[20px] resume-sheet mx-auto bg-white overflow-hidden' style={{ borderColor: resumeInfo?.themeColor, width: '210mm', minHeight: '297mm' }}>
