  ...
  return (
    <div>
        <h2 className='font-bold text-xl text-center' style={{color:resumeInfo?.themeColor}}>
            {resumeInfo?.firstName} {resumeInfo?.firstName}</h2>
            ...
            <div className='flex justify-between'>
                <h2 className='font-noraml text-xs'  style={{color:resumeInfo?.themeColor}}>{resumeInfo?.phone}</h2>
                <h2 className='font-noraml text-xs'  style={{color:resumeInfo?.themeColor}}>{resumeInfo?.email}</h2>
            </div>
